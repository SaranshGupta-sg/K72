  ...
  useGSAP(() => {
    gsap.to(imageDivRef.current, {
      scrollTrigger: {
        ...
        onUpdate: (elem) => {
          // console.log(Math.floor(elem.progress * imageArray.length)); // console me 1 - 14 tk print ho jaega
      ...
      <div className='section1 relative py-1'>
        ...
        <div className='relative font-[font2]'>
          <div className='lg:mt-[55vh] mt-[30vh]'>
            <h1 className='text-[20vw] text-center uppercase leading-[18vw] text-black'>Soixan7e
              Douze</h1>
          </div>
