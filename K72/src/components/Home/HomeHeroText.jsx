...
const HomeHeroText = () => {
  return (<div className='font-[font1] pt-5 text-center'>
    ...
    <div className='text-[9vw] justify-center flex items-start uppercase leading-[8vw]'>qui <div className='h-[6.7vw] rounded-3xl overflow-hidden'><Video /></div> génère</div>
